...
class SamPeftStepRunner:
    ...
    def __call__(self, batch, *args, **kwargs):
        ...
        # ---> image encoder <---
        image_embeddings = self.net.base_model.model.image_encoder(features)
        # ---> prompt encoder <---
        sparse_embeddings, dense_embeddings = self.net.base_model.model.prompt_encoder(
            points=points,
            boxes=bboxes,
            masks=None
        )
        ...
        # ---> mask decoder <---
        low_res_masks, iou_predictions = self.net.base_model.model.mask_decoder(
            image_embeddings=image_embeddings,
            image_pe=self.net.base_model.model.prompt_encoder.get_dense_pe(),
        ...
        trans = ResizeLongestSide(
            self.net.base_model.model.image_encoder.img_size
        )
